...
const ResearchReportPage = () => {
  ...
  const reportData = {
    ...
    recentDisaster: "집중호우",
    weather: "28°C",
    latitude: "35.1573993528928616",
    longitude: "129.161087129035",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
            ...
            <div className="flex flex-col justify-between h-full space-y-4">
              ...
              <div className="flex flex-col space-y-2">
                <p className="text-gray-700 font-medium">• 쓰레기 예측량</p>
                <div className="flex space-x-2">
                  <p className="border border-gray-300 rounded-md px-3 py-2 bg-gray-50 w-1/3">
                    {reportData.estimatedTrash}
                  </p>
                  <p className="border border-gray-300 rounded-md px-3 py-2 bg-gray-50 w-1/3">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70">
          <div className="bg-white rounded-lg shadow p-6">
            <p className="text-center mb-4 font-bold">
              ‘{reportData.reportTime} {reportData.beachName}’에 청소자를
              배정하셨습니까?
            </p>
